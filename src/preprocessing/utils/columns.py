...
NORM_COLUMNS = [C_AGE, C_WEIGHT, C_GCS, C_HR, C_SYSBP, C_MEANBP, C_DIABP, C_RR, C_TEMP_C, C_FIO2_1,
            ...
            C_ARTERIAL_BE, C_SOFA, C_SIRS, C_SHOCK_INDEX, C_PAO2_FIO2,
            C_ELIXHAUSER, C_CO2_MEQL, C_IONISED_CA, C_BLOC]

LOG_NORM_COLUMNS = [C_SPO2, C_BUN, C_CREATININE, C_SGOT, C_SGPT, C_TOTAL_BILI, C_INR, C_URINE_OUTPUT, C_ARTERIAL_LACTATE]
