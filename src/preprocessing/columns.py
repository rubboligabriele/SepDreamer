...
AS_IS_COLUMNS = [C_GENDER, C_MECHVENT, C_RE_ADMISSION]

NORM_COLUMNS = [C_AGE, C_WEIGHT, C_GCS, C_HR, C_SYSBP, C_MEANBP, C_DIABP, C_RR, C_TEMP_C, C_FIO2_1,
            C_MAGNESIUM, C_CALCIUM, C_WBC_COUNT, C_PLATELETS_COUNT, C_PTT, C_PT, C_ARTERIAL_PH, C_PAO2, C_PACO2,
            C_ARTERIAL_BE, C_ARTERIAL_LACTATE, C_SOFA, C_SIRS, C_SHOCK_INDEX, C_PAO2_FIO2,
            C_ELIXHAUSER, C_CO2_MEQL, C_IONISED_CA, C_BLOC]

LOG_NORM_COLUMNS = [C_SPO2, C_BUN, C_CREATININE, C_SGOT, C_SGPT, C_TOTAL_BILI, C_INR, C_URINE_OUTPUT]

ALL_FEATURE_COLUMNS = AS_IS_COLUMNS + NORM_COLUMNS + LOG_NORM_COLUMNS

STATE_COLUMNS = [
    C_GENDER, C_MECHVENT, C_RE_ADMISSION, C_AGE, C_WEIGHT,
    C_GCS, C_HR, C_SYSBP, C_MEANBP, C_DIABP,
    C_RR, C_TEMP_C, C_FIO2_1, C_MAGNESIUM, C_CALCIUM,
    C_WBC_COUNT, C_PLATELETS_COUNT, C_PTT, C_PT, C_ARTERIAL_PH,
    C_PAO2, C_PACO2, C_ARTERIAL_BE, C_ARTERIAL_LACTATE,
    C_SOFA, C_SIRS, C_SHOCK_INDEX, C_PAO2_FIO2,
    C_SPO2, C_BUN, C_CREATININE, C_SGOT, C_SGPT,
    C_TOTAL_BILI, C_INR, C_URINE_OUTPUT, C_ELIXHAUSER, C_CO2_MEQL, C_IONISED_CA,
    C_BLOC
]