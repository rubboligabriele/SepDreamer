...
NORM_COLUMNS = [C_AGE, C_WEIGHT, C_GCS, C_HR, C_SYSBP, C_MEANBP, C_DIABP, C_RR, C_TEMP_C, C_FIO2_1,
            ...
            C_ARTERIAL_BE, C_ARTERIAL_LACTATE, C_SOFA, C_SIRS, C_SHOCK_INDEX, C_PAO2_FIO2, C_CUMULATED_BALANCE,
            C_ELIXHAUSER, C_CO2_MEQL, C_IONISED_CA]

LOG_NORM_COLUMNS = [C_SPO2, C_BUN, C_CREATININE, C_SGOT, C_SGPT, C_TOTAL_BILI, C_INR,
            C_INPUT_TOTAL, C_INPUT_STEP, C_OUTPUT_TOTAL, C_OUTPUT_STEP, C_URINE_OUTPUT, C_MAX_DOSE_VASO]
